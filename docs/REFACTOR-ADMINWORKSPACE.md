...
- [~] Leads (en piezas): **3.5** `AdminLeadsTable.tsx` (vista tabla por estado con acciones por lead, −200 líneas). **Falta** el toolbar de Leads (header+filtros, ~180 líneas; kanban y AddLeadDialog ya son componentes). Luego pestaña Empresa.
