  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // `max-h`/`overflow-y-auto` por defecto evitan que diálogos altos se recorten en móvil.
          // Los consumidores que definen su propia altura/overflow ganan (tailwind-merge dedupe).
